  ...
  return (
    <div className="bg-[#F4F1EA] text-[#1A1A1A] font-sans overflow-hidden animate-in fade-in duration-300">
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 border-b border-[#1A1A1A]/10">
        <div className="flex flex-col md:flex-row justify-between items-baseline gap-4 mb-12 border-b border-stone-300 pb-6">
          <div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-56 overflow-hidden bg-stone-200 grayscale-20 hover:grayscale-0 transition-all duration-500">
                  ...
                  {car.badge && (
                    <span className="absolute top-4 left-4 z-10 px-3 py-1 bg-stone-950 text-[#F4F1EA] text-[9px] font-bold uppercase tracking-[0.15em] border border-[#F4F1EA]/20">
                      {car.badge}
                    </span>
                  )}
                  ...
                  <div className="absolute inset-x-0 bottom-0 bg-stone-950/40 p-4 flex justify-end opacity-0 group-hover:opacity-100 transition-opacity">
                    <button
                      onClick={() => onQuickView(car)}
                      className="px-3 py-1.5 bg-[#FAF8F5] text-stone-950 text-[10px] font-sans font-bold uppercase tracking-wider flex items-center gap-1 hover:bg-[#F4F1EA]"
                    >
