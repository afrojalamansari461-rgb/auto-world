        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 bg-stone-900 border border-stone-800 flex items-center justify-center text-[#F4F1EA]">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs font-sans uppercase tracking-widest">
              <li>
                <a href="#" className="hover:text-white transition text-stone-400 block hover:underline">
                  Privacy Policy
                </a>
              </li>
              <li>
              ...
              <li>
                <button onClick={() => handleLinkClick("contact")} className="hover:text-white transition cursor-pointer text-stone-400 hover:underline">
                  FAQs & Support
                </button>
              </li>
            </ul>
